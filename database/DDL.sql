...
-- -------------------------------------------
DROP PROCEDURE IF EXISTS sp_reset_trophytracker;
DELIMITER //
CREATE PROCEDURE sp_reset_trophytracker()
BEGIN
...
END //
DELIMITER ;
-- CALL sp_reset_trophytracker(); -- uncomment to reset database schema back to original state
